...
A table of the labels is provided in Supplementary Table~\ref{tab:s3-labels}.
...
\begin{figure}[hbpt]
    \centering
    \includegraphics[width=\textwidth]{pics/fig2_methods-segmentation.pdf}
...
\added[id=R2, comment={R2-2a, R2-5: Element type and mesh density control}]{
    ...
    parameter specifications are provided in Supplementary Table~\ref{tab:s2-cgal-params}.
}
...
is available in Supplementary Table~\ref{tab:s2-cgal-params}. 
...
\begin{figure}[hbpt]
    \centering
    \includegraphics[width=\textwidth]{pics/fig3_methods-meshing.pdf}
...
\begin{figure}[hbpt]
    \centering
    \includegraphics[width=\linewidth]{pics/fig4_methods-model-creation.pdf}
