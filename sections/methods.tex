...
\begin{figure}[hbpt]
    ...
    \caption{
        ...
        splits the pulmonary veins into superior and inferior \added[id=JASL]{(marked by contrasting colours)}.
...
\added[id=JASL]{
    following the coordinate transformation approach described by~\citet{strocchi2020_simulating},
} 
