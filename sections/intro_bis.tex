...
Patient-specific computational models and simulations \deleted[id=JASL]{(\CMnS)} of the heart have increasingly  
...
of data used for \replaced[id=JASL]{computational models and simulations}{\CMnS}~\cite{steuernagel2023_sex_bias}.
...
In this study, we \replaced[id=JASL]{developed}{present} CEMRG Heartbuilder, 
...
\deleted[id=JASL]{The aim of this study is to develop a workflow for creating hearts, 
