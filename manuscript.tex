...
\newcommand{\autor}{%
    ...
    Christoph Augustin\textsuperscript{4,5},
...
\\
\bigskip
\textbf{1} National Heart and Lung Institute, Imperial College London, London, United Kingdom \\
\textbf{2} School of Biomedical Engineering and Imaging Sciences, King's College London, London, United Kingdom \\
\textbf{3} School of Engineering and Materials Science, Queen Mary University of London, London, United Kingdom \\
\textbf{4} Gottfried Schatz Research Center, Division of Medical Physics and Biophysics, Medical University of Graz, Graz, Austria \\
\textbf{5} BioTechMed-Graz, Graz, Austria \\
\textbf{6} Cardiac Rhythm Management, Medtronic, London, United Kingdom\\
\textbf{7} Food and Drug Administration, Silver Spring, Maryland, United States of America\\
\textbf{8} Alan Turing Institute, London, United Kingdom \\
\bigskip
...
\section*{Abstract}
    ...
    \replaced[id=PLOS, comment={EM: remove URLs from Abstract; DOI and repository links remain in the Data Availability statement}]{
        The resulting virtual cohort captures key anatomical variability and is publicly available, along with the underlying code (see Data Availability statement).
