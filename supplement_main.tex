...
% -------------------------------------------------------------------------
\input{sections/supp/s_fig1_tat_qrs}


% -------------------------------------------------------------------------
% S1 TABLE: Geometric Characteristics
% -------------------------------------------------------------------------
\input{sections/supp/s_tab1_geometric}

% -------------------------------------------------------------------------
% S2 FIGURE: Correlation Heatmap
% -------------------------------------------------------------------------
\input{sections/supp/s_fig2_correlation_heatmap}

% -------------------------------------------------------------------------
% S2 TABLE: CGAL Parameters
% -------------------------------------------------------------------------
\input{sections/supp/s_tab2_cgal_params}

% -------------------------------------------------------------------------
% S3 TABLE: 37-Label Specification
% -------------------------------------------------------------------------
\input{sections/supp/s_tab3_labels}

% -------------------------------------------------------------------------
% S1 TEXT: Boundary Conditions
% -------------------------------------------------------------------------
\input{sections/supp/s_text1_boundary_conditions}

% -------------------------------------------------------------------------
% S3 FIGURE: Mesh Quality Distribution
% -------------------------------------------------------------------------
\input{sections/supp/s_fig3_mesh_quality}
