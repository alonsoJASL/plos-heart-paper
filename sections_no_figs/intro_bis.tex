...
\begin{figure}[hbpt]
    ...
    \caption{
        ...
        Heart icons in this figure were derived from a CC0 image obtained from openclipart.org (https://openclipart.org/246884) and modified to fit the figure design.
    }
...
Fig~\ref{fig:heartbuilder_pipeline} provides an overview of the pipeline and the resulting cohort.
